...
const GAP_BLOCKED = [
  {
    ...
    detail: "Market price is 15% lower than your wholesale cost. Customers will defect.",
...
function MarketGapsSection() {
  ...
  const tabBtn = (label: string, key: "stock" | "blocked") => (
    <button
      onClick={() => setTab(key)}
      style={{
        padding: "7px 16px",
  ...
  return (
    <div style={{ marginBottom: 22 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
        <div>
          <h2 style={{ fontSize: 14, fontWeight: 700, color: C.ink, margin: 0, fontFamily: "Gilroy, system-ui, sans-serif" }}>
            AI Market Gaps
          </h2>
          <p style={{ fontSize: 12, color: C.sub, margin: "3px 0 0", fontFamily: "Gilroy, system-ui, sans-serif" }}>
            Detected from local search trends, social media signals &amp; inventory velocity
          </p>
        </div>
        <div style={{ display: "flex", borderBottom: `1px solid ${C.border}` }}>
          {tabBtn("Stock Opportunities (3)", "stock")}
          {tabBtn("Blocked — Do Not Stock (3)", "blocked")}
        </div>
      </div>
            ...
            <div key={item.product} style={{ background: C.white, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
              ...
              <div style={{ padding: "14px 16px" }}>
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8, marginBottom: 8 }}>
                  <div>
                    <p style={{ fontSize: 13, fontWeight: 700, color: C.ink, margin: 0, fontFamily: "Gilroy, system-ui, sans-serif" }}>{item.product}</p>
                    <p style={{ fontSize: 11, color: C.sub, margin: "2px 0 0", fontFamily: "Gilroy, system-ui, sans-serif" }}>{item.category}</p>
                  </div>
                  <span style={{
                    background: C.tint,
                    color: C.green,
                ...
                <p style={{ fontSize: 12, color: C.sub, margin: "0 0 10px", fontFamily: "Gilroy, system-ui, sans-serif", lineHeight: 1.5 }}>{item.signal}</p>

                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 12 }}>
                  <div style={{ background: "#f9f6f1", borderRadius: 6, padding: "8px 10px" }}>
                    <p style={{ fontSize: 10, fontWeight: 700, color: C.sub, margin: "0 0 2px", fontFamily: "Gilroy, system-ui, sans-serif", textTransform: "uppercase", letterSpacing: "0.05em" }}>Search Trend</p>
                    <p style={{ fontSize: 15, fontWeight: 800, color: C.green, margin: 0, fontFamily: "Gilroy, system-ui, sans-serif" }}>{item.trendPct}</p>
                  </div>
                  <div style={{ background: "#f9f6f1", borderRadius: 6, padding: "8px 10px" }}>
                    <p style={{ fontSize: 10, fontWeight: 700, color: C.sub, margin: "0 0 2px", fontFamily: "Gilroy, system-ui, sans-serif", textTransform: "uppercase", letterSpacing: "0.05em" }}>Est. Rev Added</p>
                    <p style={{ fontSize: 13, fontWeight: 800, color: C.ink, margin: 0, fontFamily: "Gilroy, system-ui, sans-serif" }}>{item.estRev}</p>
                  </div>
                </div>
          ...
          {GAP_BLOCKED.map((item) => (
            <div key={item.product} style={{ background: C.white, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
              ...
              <div style={{ padding: "14px 16px" }}>
                ...
                <p style={{ fontSize: 12, color: C.sub, margin: "0 0 8px", fontFamily: "Gilroy, system-ui, sans-serif", lineHeight: 1.5 }}>{item.detail}</p>

                <div style={{ background: "#fef9f0", border: "1px solid #f0e6cc", borderRadius: 6, padding: "9px 11px", marginBottom: 12 }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: "#92400e", margin: "0 0 2px", fontFamily: "Gilroy, system-ui, sans-serif", textTransform: "uppercase", letterSpacing: "0.05em" }}>AI Action</p>
                  <p style={{ fontSize: 12, color: "#92400e", margin: 0, fontFamily: "Gilroy, system-ui, sans-serif", lineHeight: 1.5 }}>{item.action}</p>
                </div>
