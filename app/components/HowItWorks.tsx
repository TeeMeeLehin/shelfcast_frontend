  ...
  return (
    <section className="sc-section-dark" style={{ background: "#0d3a10", color: "#fff" }}>
      <div className="sc-hiw-header">
        <h2 style={{ fontFamily: "'ESKlarheit',sans-serif", fontWeight: 800, fontSize: "clamp(30px,4vw,48px)", lineHeight: 1.1, letterSpacing: "-0.025em", margin: 0 }}>
          Three steps from<br />chaos to clarity
        </h2>
        <p style={{ fontSize: 16, lineHeight: 1.6, color: "rgba(255,255,255,0.78)", margin: 0, fontFamily: "'Gilroy',sans-serif" }}>
      ...
      <div className="sc-hiw-steps">
        {steps.map(s => (
          <div key={s.n} style={{ border: "1px solid rgba(255,255,255,0.18)", borderRadius: 14, padding: 36, background: "rgba(255,255,255,0.03)" }}>
            <div style={{ fontFamily: "'ESKlarheit',sans-serif", fontWeight: 800, fontSize: 14, color: "#E8A205", letterSpacing: "0.05em", marginBottom: 32 }}>{s.n}</div>
            <h3 style={{ fontFamily: "'ESKlarheit',sans-serif", fontWeight: 700, fontSize: 22, letterSpacing: "-0.02em", margin: 0, marginBottom: 12 }}>{s.t}</h3>
            <p style={{ fontSize: 14, lineHeight: 1.55, color: "rgba(255,255,255,0.72)", margin: 0, fontFamily: "'Gilroy',sans-serif" }}>{s.d}</p>
          </div>
        ))}
      </div>
    </section>
